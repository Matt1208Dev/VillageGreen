    ...
    <?php echo form_open('Customer/signUp', 'class="row"');?>
            ...
            <div class="col-sm-12 col-md-6">
                <div class="col-sm-12 col-lg-9 mx-lg-auto mb-sm-4">
                    <div class="row pe-md-4 px-sm-3">
                        ...
                        <input class="form-control col bg-grey" type="email" name="cus_mail" id="email" value="<?php echo set_value('cus_mail');?>">                       
                    </div>
        ...
        <div class="col-sm-12 col-md-6 me-4 mb-3">
            ...
            <div class="px-0 mt-sm-1 px-sm-0">
                <p class="d-inline-block col-4 text-md-end px-3">Je suis un : </p>
                <div class="form-check form-check-inline col-sm-3">
                    <input class="form-check-input bg-grey" type="radio" value="Particulier" name="cus_type" id="cus_type" value="<?php echo set_value('cus_type');?>">
                    <label class="form-check-label" for="cus_type">Particulier</label>
                </div>
                <div class="form-check form-check-inline col-sm-3">
                    <input class="form-check-input bg-grey" type="radio" value="Professionnel" name="cus_type" id="cus_type" value="<?php echo set_value('cus_type');?>">
            ...
            <div class="row">
                <div id="phone-form-box" class="col mx-auto border border-bottom-0 border 1 border-dark">
                    ...
                    <div class="row align-items-center mb-3">
                        ...
                        <input class="form-control col bg-grey me-5" type="text" name="cus_phone" id="cus_phone" value="<?php echo set_value('cus_phone');?>">
