...
<body>
    ...
    <div class="main-container container justify-content-between p-0">
            ...
            <nav class="navbar navbar-expand-lg container-fluid p-0">
                ...
                <div class="row container-fluid p-0 m-0 ">
                    <div id="navlogo" class="p-0">
                        <!-- <a class="navbar-brand" href="<?php echo site_url('Products/accueil'); ?>"> -->
                    ...
                    <div id="navbar" class="p-0">
                                        ...
                                        <div id="item-client-submenu" class="justify-content-center py-3 px-4 bg-white rounded">
                                            <div class="border-end border-1 border-warning d-flex flex-column align-items-stretch">
                                                ...
                                                <div class="d-flex flex-column justify-content-center align-content-center px-2">
                                                    <div class="mb-3">
                                                        <input class="form-control border" type="text" name="cus_mail" id="login-email" placeholder="Adresse E-mail" autocomplete="off" value="<?php echo set_value('cus_mail');?>">
                                                        <?php if(isset($errorMsg['cus_mail'])){ ?><div class="fw-bold text-danger"><?php echo $errorMsg['cus_mail'];?></div><?php };?>
                                                    </div>
                                                    <div class="mb-3">
                                                        <input class="form-control" type="password" name="cus_pass" id="login-password" placeholder="Mot de passe" <?php echo set_value('cus_pass');?>>
                        ...
                        <div class="row m-0" id="nav-second-row">
                            <div class="container navbar p-1">
                                <a class="nav-link fw-bold py-1" href="#">Products</a>
