...
<div class="container-fluid min-vh-75 mt-5 px-0">
    <div class="row justify-content-center">
        <div class="col-12 col-md-10 d-flex flex-column justify-content-center align-items-center">
            <p class="fs-2 mb-5 text-center">Merci <?php if (isset($_SESSION['username'])){echo $_SESSION['username'];} ?> pour votre commande n°<?php if (isset($cus_id)){echo $cus_id[0]->ord_id;} ?>.</p>
