                    ...
                    <?php 
                        ...
                        {   
                            ...
                            <tr class="table-light">
                                ...
                                <td class="col-xl-2">
                                    <div class="col-12">
                                        <img class="img-mini" src="<?php if(isset($row['pro_id']) && (isset($row['pro_photo']))){echo base_url('assets/images/products/' . $row['pro_id'] . '.' . $row['pro_photo']) ;} ?>" alt="photo du produit <?php if(isset($row['pro_label'])){echo $row['pro_label'];}?>" title="<?php if(isset($row['pro_label'])){echo $row['pro_label'];}?>">
                                    </div>
                                </td>
                                <!-- Libellé produit -->
            ...
            <div class="table-responsive">
                <table class="table table-hover text-center">
                    ...
                    <tbody>
                        ...
                        <tr class="table-light">
                            <td class="col-6 text-end">Total <?php if(isset($row['cus_type']) && $row['cus_type'] == 'Particulier'){echo 'TTC';}else{echo 'HT';}?> :</td>
...
{ 
    ...
    <div class="row m-0">
        ...
        <div id="banner-delivery" class="col-12 col-md-3 d-flex flex-column align-items-center justify-content-center mb-4 px-0">  
                <img class="img-fluid px-0 d-none d-sm-inline" src="<?php echo base_url('assets/images/BODY/banniere droite prix.png');?>" alt="image livraison gratuite à partir de 19€ d'achats" title="Livraison gratuite à partir de 19€ d'achats">
                <img class="img-fluid mx-auto pt-3 col-6 d-flex d-sm-none p-0" src="<?php echo base_url('assets/images/BODY/banniere droite prix sm.png');?>" alt="image livraison gratuite à partir de 19€ d'achats" title="Livraison gratuite à partir de 19€ d'achats">
        </div>
    </div>
<?php 
} ?>
