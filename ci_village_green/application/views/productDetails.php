...
<section class="container-fluid p-0">
    ...
    <article id="product-details" class="row flex-wrap m-0 ">
        <!-- Box visuel produit -->
        <div id="product-image" class="col-12 col-md-6 py-2">
            <img class="img-fluid mh-100" src="<?php if(isset($product[0]->pro_id) && (isset($product[0]->pro_photo))){echo base_url('assets/images/products/' . $product[0]->pro_id . '.' . $product[0]->pro_photo) ;} ?>" alt="photo du produit <?php if(isset($product[0]->pro_label)){echo $product[0]->pro_label;}?>" title="<?php if(isset($product[0]->pro_label)){echo $product[0]->pro_label;}?>">
        </div>
        <!-- Box disponibilité -->
        <div id="product-stat" class="col-12 col-md-6">
            ...
            <div class="details-body row flex-wrap m-0">
                ...
                <!-- Box prix -->
                <div class="details-price col-12 col-md-6 d-flex flex-column-reverse">
                ...
                ?>
                    ...
                    <div>
                        ...
                        <?php        
                                ...
                                {
                        ?>
                                    <p class="your-price"><b><?php echo number_format(($product[0]->pro_ppet + ($product[0]->pro_ppet * $customer[0]->cus_coef/100)), 2, ",", " ");?> € HT</b></p>
                        <?php
                                ;}
                            ;}
                            else
