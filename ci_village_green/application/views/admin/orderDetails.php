        ...
        <table id="table-order-details" class="table table-hover table-borderless align-middle text-center overflow-hidden mb-0">
            ...
            <tbody>
                ...
                <tr class="bg-light border-0 border-top border-4">
                    ...
                    <th scope="col"><?php if(isset($product->pro_desc)){ echo substr($product->pro_desc, 0, 55) . '...';}?></th>
            ...
            <tfoot class="bg-white">
                ...
                <tr class="bg-white border-0 border-top border-4">
                    ...
                    <td class="pt-2 px-0"><?php if(isset($total)){echo 'EUR ' . number_format($total, 2, ".", " ");}?></td>
                </tr>
                <tr class="bg-white">
                    <td colspan="5" class="pt-0"></td>
                    <td class="pt-0">TVA : </td>                  
                    <td class="pt-0 px-0"><?php if(isset($total)){echo 'EUR ' . number_format($total*$product->ode_tax_rate/100, 2, ".", " ");}?></td>
                </tr>
            
                <tr>
                <td colspan="5" class="pt-0"></td>
                    <span class="rounded-bottom"><td class="fw-bold pt-0">Total : </td>
                    <td class=" fw-bold text-danger pt-0 px-0"><?php if(isset($total)){echo 'EUR ' . number_format(($total+($total*$product->ode_tax_rate/100)), 2, ".", " ");}?></td></span>
                </tr>
            </tfoot>
        </table>
    </div>
