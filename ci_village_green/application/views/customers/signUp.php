<section class="container-fluid">
    <!-- FORM -->
    <?php echo form_open('Customers/signUp', 'id="form"');?>
        <div class="col-12">
            <!-- Title -->
            <header>
                <h2 class="text-center mb-3 mb-md-5 fs-sm-3 mt-4 mt-md-0">
        ...
        <div class="col-12">
            <!-- Title -->
            <header>
                <h2 class="text-center mb-3 mb-md-5 mt-4 mt-md-0">
                    Vos informations
                </h2>
            </header>
        </div>
    ...
    <div class="row p-0">
        <div class="col-sm-12 col-md-6 me-0 me-md-4 mb-3">
            <!-- Firstname field -->
            <div class="col-sm-12 col-lg-9 row align-items-center justify-content-center mx-sm-0 mx-lg-auto h-100 px-0">
                ...
                <div class="px-0 mt-sm-1 px-sm-0">
                    <p class="d-inline-block col-4 text-md-end px-3 my-2 my-md-0">Sexe</p>
                ...
                <!-- Status field -->
                <div class="px-0 mt-sm-1 px-sm-0">
                    <p class="d-inline-block col-4 text-md-end px-3 my-2 my-md-0">Je suis un : </p>
                    <div class="form-check form-check-inline col-sm-3">
        ...
        <div class="col-sm-12 col-md-5 px-4 ms-0 ms-md-0 mb-3 mx-sm-0">
            <div class="row">
                <div id="phone-form-box" class="col mx-auto border border-bottom-0 border 1 border-dark">
                    ...
                    <div class="row align-items-center mb-3">
                        <label class="form-label text-end col-4 col-md-5" for="cus_phone">Tel mobile</label>
                    ...
                    <div class="row align-items-center mb-3">
                        <label class="form-label text-end col-4 col-md-5" for="cus_xxx">Tel fixe</label>
        ...
        <div class="row p-0 justify-content-center">
            <input class="btn btn-lg my-sm-0 my-md-5 col-sm-11 col-md-2 text-white fw-bold orange-gradient" type="submit" value="Valider">
        </div>
    </form>
    <!-- ENF FORM -->
</section>
